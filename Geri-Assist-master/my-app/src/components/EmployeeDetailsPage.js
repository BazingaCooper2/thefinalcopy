  ...
  useEffect(() => {
    fetch("http://127.0.0.1:5000/employees")
      ...
      .then((data) => {
        ...
        const enhancedData = (data.employee || []).map(emp => ({
          ...emp,
      ...
      <div className="row g-3 mb-4">
        ...
        <div className="col-md-3">
          <div className="dashboard-card card-green">
            <div className="dashboard-card-value">{employees.filter(e => e.status === 'Available').length}</div>
        ...
        <div className="col-md-3">
          <div className="dashboard-card card-cyan">
            <div className="dashboard-card-value">{employees.filter(e => e.status === 'On Leave' || e.status === 'Sick').length}</div>
